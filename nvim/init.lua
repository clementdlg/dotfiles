...
vim.opt.showcmd = true --display keystrokes
vim.opt.wrap = true --wrap long lines
vim.opt.linebreak = true --wrap lines between words
vim.opt.signcolumn = "yes" --Sign column (left)
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					-- This function sets the mode, buffer and description for us each time.
...
#                  #
					...
					map("<leader>rt", vim.lsp.buf.hover, "Hover Documentation")
